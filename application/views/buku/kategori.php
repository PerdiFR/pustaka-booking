                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('buku/hapusbuku/') . $k['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['nama_kategori']; ?>?');" class="badge badge-danger">
            ...
            <form action="<?= base_url('buku/kategori'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Masukan Nama Kategori" class="form-control form-control-user">
                    </div>
                </div>
